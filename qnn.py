...
Usage:
    python qnn.py --train       # Train & save weights
    python qnn.py --evaluate    # Load weights & show metrics
    python qnn.py --predict     # Load weights & show predicted images
"""
...
ALGO_NAME   = "QNN"
WEIGHT_FILE = os.path.join(SAVED_DIR, "qnn_weights.pt")
WEIGHT_SHAPE = (3, N_QUBITS)  # 3 layers of BasicEntanglerLayers
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description=f"{ALGO_NAME} - Quantum Neural Network")
